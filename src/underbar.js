(function() {
  ...
  _.each = function(collection, iterator) {
    /*
    if an array
      loop over  and call iterate [key, index, array]

    if an object
      loop over call iterator [key, value, object]
    */
    ...
    if (Object.keys(collection).length > 0 && !Array.isArray(collection)) {
  ...
  _.every = function(collection, iterator) {
    ...
    /*
    Call reduce and pass true as the accumulator, collection, iterator
      Callback function
        If accumulator === false
          return false
        else
          return iterator of current item
    */
    ...
    return _.reduce(collection, function(accumulator, item) {
      if (accumulator === false || !iterator(item)) {
        return false;
  ...
  */
    ...
    var everyResult = _.every(collection, function(item) {
